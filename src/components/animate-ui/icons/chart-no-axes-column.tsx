...
function IconComponent({ size, ...props }: ChartNoAxesColumnProps) {
  ...
  return (
    <motion.svg
      ...
      {...props}
    >
      <motion.path d='M5 21V15' variants={variants.path1} initial='initial' animate={controls} />
      <motion.path d='M12 21V3' variants={variants.path2} initial='initial' animate={controls} />
      <motion.path d='M19 21V9' variants={variants.path3} initial='initial' animate={controls} />
    </motion.svg>
  )
}
